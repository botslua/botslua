...
function luatele_function.editMessageCaption(chat_id, message_id, text, parse_mode, reply_markup)
if text and parse_mode then
text = luatele_function.parseTextEntities(text,parse_mode)
else
text = text
end
local luatele_body = {
